...
testthat::test_that("TE", {
  testthat::expect_equal(round(psr::TE(subject_1, trial_1, metric_1), 1)[1, 1], 2.9)
})

testthat::test_that("TE", {
  testthat::expect_equal(round(psr::TE(subject_2, trial_2, metric_2), 1)[1, 1], 1.4)
})
