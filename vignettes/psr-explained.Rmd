...
The Standard Error of Measurement (SEM) is similar to the TE and CV, and can be seen as another way of quantifying the amount of variability between athletes: it  however: it utilizes the ICC, which is another measure of reliability. The formula for the SEM is the between-subject standard deviation of each athlete's scores multiplied by root (1 - ICC). 
