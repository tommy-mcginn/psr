...
Running the code, the familiar form of the output is displayed, It shows the SEM for each metric, which is useful as a way of comparing the reliability of metrics.
