# If you enter the following code, the functions should produce an error because the trials are not labeled uniformly across all subjects
...
# If you enter the following code, the functions should produce an error because metric 1 is not a numeric vector
subject <- c(1, 1, 1, 2, 2, 2, 3, 3, 3)
