...
#' prob_rel_chng(subject, trial, metric_1, metric_2, metric_3, ICC, initial, final)
#'
#' @references Ferger, K., & Büsch, D. (2018). Individual measurement of performance change in sports. Deutsche Zeitschrift Für
#'   Sportmedizin, 2018(02), 45-52.
#'
#' @export
prob_rel_chng <- function(subject, trial, ..., ICC, initial, final) {
  ...
  output_df <- data.frame(Metric = paste("Probability"))
